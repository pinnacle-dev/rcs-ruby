  ...
  module Wrapper
    module Tools
      class FileUploader < Pinnacle::Tools::File::Client
        ...
        # @raise [Pinnacle::Errors::NotFoundError] If file not found
        # @raise [Pinnacle::Errors::ClientError] If path is a directory
        # @raise [Pinnacle::Errors::ServerError] If upload fails
