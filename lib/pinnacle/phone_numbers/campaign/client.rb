  ...
  module PhoneNumbers
    module Campaign
      class Client
        ...
        # @param params [Pinnacle::PhoneNumbers::Campaign::Types::AttachCampaignParams]
        ...
        def attach(request_options: {}, **params)
          ...
          if code.between?(200, 299)
            Pinnacle::Types::AttachedPhoneNumberResult.load(response.body)
          else
        ...
        #
        # @param request_options [Hash]
        # @param params [Pinnacle::PhoneNumbers::Campaign::Types::DetachCampaignParams]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        def detach(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Pinnacle::Types::DetachedPhoneNumberResult.load(response.body)
          else
            error_class = Pinnacle::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
