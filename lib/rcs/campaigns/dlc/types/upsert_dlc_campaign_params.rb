    ...
    module Dlc
      module Types
        class UpsertDlcCampaignParams < Internal::Types::Model
          ...
          field :keywords, -> { Rcs::Campaigns::Dlc::Types::DlcCampaignKeywords }, optional: true, nullable: false
          field :links, -> { Rcs::Campaigns::Dlc::Types::DlcCampaignLinks }, optional: true, nullable: false
          field :message_flow, -> { String }, optional: true, nullable: false, api_name: "messageFlow"
          field :name, -> { String }, optional: true, nullable: false
          field :options, -> { Rcs::Campaigns::Dlc::Types::DlcCampaignOptions }, optional: true, nullable: false
          field :sample_messages, -> { Internal::Types::Array[String] }, optional: true, nullable: false, api_name: "sampleMessages"
          field :use_case, -> { Rcs::Campaigns::Dlc::Types::DlcCampaignUseCase }, optional: true, nullable: false, api_name: "useCase"
        end
      end
    end
  end
