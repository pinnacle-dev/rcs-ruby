  ...
  module Campaigns
    module Dlc
      class Client
        ...
        #
        # @return [Rcs::Types::AutofillDlcCampaignResponse]
        def autofill(request_options: {}, **params)
          ...
          if code.between?(200, 299)
            Rcs::Types::AutofillDlcCampaignResponse.load(response.body)
          else
        ...
        #
        # @return [Rcs::Types::DlcCampaignWithExtendedBrandAndStatus]
        def get(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Rcs::Types::DlcCampaignWithExtendedBrandAndStatus.load(response.body)
          else
            error_class = Rcs::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        #
        # @param request_options [Hash]
        # @param params [Rcs::Campaigns::Dlc::Types::UpsertDlcCampaignParams]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        def upsert(request_options: {}, **params)
          ...
          request = Rcs::Internal::JSON::Request.new(
            ...
            method: "POST",
            path: "campaigns/dlc",
            body: Rcs::Campaigns::Dlc::Types::UpsertDlcCampaignParams.new(body_bag).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
