    ...
    module Blast
      module Types
        class BlastRcs < Internal::Types::Model
          ...
          field :message, -> { Rcs::Types::RcsValidateContent }, optional: false, nullable: false
          field :options, -> { Rcs::Messages::Blast::Types::BlastRcsOptions }, optional: true, nullable: false
        end
      end
    end
  end
