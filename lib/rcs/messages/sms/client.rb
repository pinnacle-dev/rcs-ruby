  ...
  module Messages
    module Sms
      class Client
        ...
        # @param params [Rcs::Messages::Sms::Types::Sms]
        ...
        #
        # @return [Rcs::Messages::Sms::Types::SmsSendResponse]
        def send_(request_options: {}, **params)
          ...
          request = Rcs::Internal::JSON::Request.new(
            ...
            body: Rcs::Messages::Sms::Types::Sms.new(body_bag).to_h,
          ...
          if code.between?(200, 299)
            Rcs::Messages::Sms::Types::SmsSendResponse.load(response.body)
          else
        ...
        #
        # @param request_options [Hash]
        # @param params [Rcs::Types::SmsContent]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        # @option request_options [Integer] :timeout_in_seconds
        #
        # @return [Rcs::Types::SmsValidationResult]
        def validate(request_options: {}, **params)
          params = Rcs::Internal::Types::Utils.normalize_keys(params)
          request = Rcs::Internal::JSON::Request.new(
            base_url: request_options[:base_url],
            method: "POST",
            path: "messages/validate/sms",
            body: Rcs::Types::SmsContent.new(params).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Rcs::Types::SmsValidationResult.load(response.body)
          else
            error_class = Rcs::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
