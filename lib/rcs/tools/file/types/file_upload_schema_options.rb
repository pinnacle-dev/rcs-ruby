  ...
  module Tools
    class File
      ...
      class FileUploadSchemaOptions
        # @return [Pinnacle::Tools::File::FileUploadSchemaOptionsDownload] Configure download settings for your uploaded file.
        ...
        # @param download [Pinnacle::Tools::File::FileUploadSchemaOptionsDownload] Configure download settings for your uploaded file.
        # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
        # @return [Pinnacle::Tools::File::FileUploadSchemaOptions]
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["download"].nil?
            ...
            download = Pinnacle::Tools::File::FileUploadSchemaOptionsDownload.from_json(json_object: download)
          end
        ...
        def self.validate_raw(obj:)
          obj.download.nil? || Pinnacle::Tools::File::FileUploadSchemaOptionsDownload.validate_raw(obj: obj.download)
        end
      end
    end
  end
