...
module Pinnacle
  class Message
    ...
    attr_reader :id
    # @return [Pinnacle::MessageMethodEnum]
    attr_reader :method
    ...
    attr_reader :sent_at
    # @return [Pinnacle::MessageStatusEnum]
    attr_reader :status
    # @return [Pinnacle::MessageProtocolEnum]
    attr_reader :type
    ...
    # @param content [Pinnacle::MessageContent]
    ...
    # @param method [Pinnacle::MessageMethodEnum]
    ...
    #  Null indicates the message is still in the queue.
    # @param status [Pinnacle::MessageStatusEnum]
    # @param type [Pinnacle::MessageProtocolEnum]
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["content"].nil?
        ...
        content = Pinnacle::MessageContent.from_json(json_object: content)
      end
    ...
    def self.validate_raw(obj:)
      Pinnacle::MessageContent.validate_raw(obj: obj.content)
      ...
      obj.method.is_a?(Pinnacle::MessageMethodEnum) != false || raise("Passed value for field obj.method is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Pinnacle::MessageStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      obj.type.is_a?(Pinnacle::MessageProtocolEnum) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
    end
  end
end
