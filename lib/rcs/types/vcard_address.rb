...
module Pinnacle
  class VcardAddress
    ...
    # @return [Array<Pinnacle::VCardAddressSchemaTypeItem>] Address type classifications.
    attr_reader :type
    ...
    # @param type [Array<Pinnacle::VCardAddressSchemaTypeItem>] Address type classifications.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::VcardAddress]
