...
module Pinnacle
  ...
  class Conversation
    ...
    # @return [Pinnacle::CampaignQuery] Campaign information if this conversation is part of a marketing campaign.
    attr_reader :campaign
    # @return [Pinnacle::ConversationContact] Contact information for the recipient in a conversation.
    attr_reader :contact
    ...
    attr_reader :notes
    # @return [Pinnacle::ConversationSender] The sender of messages in this conversation. Can be:
    ...
    # @param campaign [Pinnacle::CampaignQuery] Campaign information if this conversation is part of a marketing campaign.
    # @param contact [Pinnacle::ConversationContact] Contact information for the recipient in a conversation.
    ...
    # @param sender [Pinnacle::ConversationSender] The sender of messages in this conversation. Can be:
    #  - A phone number with its capabilities and metadata
    #  - An RCS agent with ID and name
    #  - `null` if no sender is associated
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["campaign"].nil?
        ...
        campaign = Pinnacle::CampaignQuery.from_json(json_object: campaign)
      end
      if parsed_json["contact"].nil?
        contact = nil
      else
        contact = parsed_json["contact"].to_json
        contact = Pinnacle::ConversationContact.from_json(json_object: contact)
      end
      ...
      if parsed_json["sender"].nil?
        ...
        sender = Pinnacle::ConversationSender.from_json(json_object: sender)
      end
    ...
    def self.validate_raw(obj:)
      ...
      obj.campaign.nil? || Pinnacle::CampaignQuery.validate_raw(obj: obj.campaign)
      Pinnacle::ConversationContact.validate_raw(obj: obj.contact)
      ...
      obj.sender.nil? || Pinnacle::ConversationSender.validate_raw(obj: obj.sender)
