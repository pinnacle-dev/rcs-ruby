...
module Pinnacle
  ...
  class RcsCampaignSchemaAgent
    ...
    attr_reader :color
    # @return [Array<Pinnacle::RcsCampaignSchemaAgentEmailsItem>] List of emails.
    attr_reader :emails
    # @return [Array<Pinnacle::RcsCampaignSchemaAgentPhonesItem>] List of phone numbers.
    attr_reader :phones
    # @return [Array<Pinnacle::RcsCampaignSchemaAgentWebsitesItem>] List of urls.
    ...
    # @param emails [Array<Pinnacle::RcsCampaignSchemaAgentEmailsItem>] List of emails.
    # @param phones [Array<Pinnacle::RcsCampaignSchemaAgentPhonesItem>] List of phone numbers.
    # @param websites [Array<Pinnacle::RcsCampaignSchemaAgentWebsitesItem>] List of urls.
    # @param hero_url [String] Link to the agent's hero.
    # @param icon_url [String] Link to the agent's icon.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::RcsCampaignSchemaAgent]
    ...
    def self.from_json(json_object:)
      ...
      emails = parsed_json["emails"]&.map do |item|
        item = item.to_json
        Pinnacle::RcsCampaignSchemaAgentEmailsItem.from_json(json_object: item)
      end
      phones = parsed_json["phones"]&.map do |item|
        item = item.to_json
        Pinnacle::RcsCampaignSchemaAgentPhonesItem.from_json(json_object: item)
      end
      websites = parsed_json["websites"]&.map do |item|
        item = item.to_json
        Pinnacle::RcsCampaignSchemaAgentWebsitesItem.from_json(json_object: item)
      end
