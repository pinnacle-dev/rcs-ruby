...
module Pinnacle
  class TollFreeCampaign
    ...
    # @return [Pinnacle::TollFreeCampaign]
    def initialize(campaign_id: OMIT, monthly_volume: OMIT, name: OMIT, opt_in: OMIT, production_message_content: OMIT,
                   use_case: OMIT, additional_properties: nil)
    ...
    # Deserialize a JSON object to an instance of TollFreeCampaign
    #
    ...
    # Serialize an instance of TollFreeCampaign to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
