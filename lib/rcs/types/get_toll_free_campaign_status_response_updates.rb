...
module Pinnacle
  module Types
    ...
    class GetTollFreeCampaignStatusResponseUpdates
      ...
      attr_reader :number
      # @return [Pinnacle::Types::TollFreeStatusEnum] Current assignment status of the toll free number to this campaign. <br>
      ...
      # @param status [Pinnacle::Types::TollFreeStatusEnum] Current assignment status of the toll free number to this campaign. <br>
      #  `IN_PROGRESS`: Being reviewed.<br>
      #  `WAITING_FOR_PROVIDER`: Being reviewed by our toll-free vendor.<br>
      #  `WAITING_FOR_TELECO:` Final review by carriers before number is live.<br>
      #  `VERIFIED`: Verified and ready to send messages.<br>
      ...
      # @return [Pinnacle::Types::GetTollFreeCampaignStatusResponseUpdates]
      ...
      def self.validate_raw(obj:)
        ...
        obj.status.is_a?(Pinnacle::Types::TollFreeStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      end
    end
  end
end
