...
module Pinnacle
  class VcardEmail
    # @return [Array<Pinnacle::VCardEmailSchemaTypeItem>] Email address type classifications.
    attr_reader :type
    ...
    # @param type [Array<Pinnacle::VCardEmailSchemaTypeItem>] Email address type classifications.
    # @param value [String] Email address.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::VcardEmail]
