...
module Pinnacle
  class ValidationResults
    # @return [Array<Pinnacle::ValidationErrorDetails>] List of validation errors, if any.
    attr_reader :errors
    ...
    # @param errors [Array<Pinnacle::ValidationErrorDetails>] List of validation errors, if any.
    ...
    def self.from_json(json_object:)
      ...
      errors = parsed_json["errors"]&.map do |item|
        item = item.to_json
        Pinnacle::ValidationErrorDetails.from_json(json_object: item)
      end
