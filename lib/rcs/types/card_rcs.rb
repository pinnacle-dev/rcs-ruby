...
require_relative "card_rcs_message"
require "ostruct"
require "json"
...
module Pinnacle
  class CardRcs
    ...
    # @return [Pinnacle::CardRcsMessage] The content of the message
    attr_reader :message
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["message"].nil?
        ...
        message = Pinnacle::CardRcsMessage.from_json(json_object: message)
      end
      new(
        phone_number: phone_number,
        message_type: message_type,
    ...
    # Serialize an instance of CardRcs to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
