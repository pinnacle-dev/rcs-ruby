...
module Pinnacle
  ...
  class SendSmsResponseSegments
    ...
    attr_reader :count
    # @return [Pinnacle::SendSmsResponseSegmentsEncoding] Encoding used for the message segments.
    ...
    # @param encoding [Pinnacle::SendSmsResponseSegmentsEncoding] Encoding used for the message segments.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::SendSmsResponseSegments]
    ...
    def self.validate_raw(obj:)
      ...
      obj.encoding.is_a?(Pinnacle::SendSmsResponseSegmentsEncoding) != false || raise("Passed value for field obj.encoding is not the expected type, validation failed.")
    end
  end
end
