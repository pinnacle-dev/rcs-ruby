...
module Pinnacle
  class CampaignValidationResult
    # @return [Array<Pinnacle::CampaignValidationResponseErrorsItem>] List of validation errors.
    attr_reader :errors
    ...
    # @param errors [Array<Pinnacle::CampaignValidationResponseErrorsItem>] List of validation errors.
    ...
    def self.from_json(json_object:)
      ...
      errors = parsed_json["errors"]&.map do |item|
        item = item.to_json
        Pinnacle::CampaignValidationResponseErrorsItem.from_json(json_object: item)
      end
