...
module Pinnacle
  ...
  class ConfiguredWebhook
    # @return [Pinnacle::AttachWebhookResponseWebhook] Detailed information about the attached webhook.
    attr_reader :webhook
    # @return [Pinnacle::WebhookEventEnum] Specific event type configured for this webhook attachment.
    attr_reader :event
    ...
    # @param webhook [Pinnacle::AttachWebhookResponseWebhook] Detailed information about the attached webhook.
    # @param event [Pinnacle::WebhookEventEnum] Specific event type configured for this webhook attachment.
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["webhook"].nil?
        ...
        webhook = Pinnacle::AttachWebhookResponseWebhook.from_json(json_object: webhook)
      end
    ...
    def self.validate_raw(obj:)
      Pinnacle::AttachWebhookResponseWebhook.validate_raw(obj: obj.webhook)
      obj.event.is_a?(Pinnacle::WebhookEventEnum) != false || raise("Passed value for field obj.event is not the expected type, validation failed.")
