...
module Pinnacle
  class ExtendedRcsCampaign
    # @return [Pinnacle::RcsCampaignSchemaExtraAgent] Agent configured to the campaign.
    attr_reader :agent
    ...
    # @return [Pinnacle::RcsCampaignSchemaExtraLinks] Legal documentation links.
    attr_reader :links
    # @return [Pinnacle::RcsCampaignSchemaExtraOptIn] Opt-in configuration.
    attr_reader :opt_in
    # @return [Pinnacle::RcsCampaignSchemaExtraOptOut] Opt-out configuration.
    attr_reader :opt_out
    # @return [Pinnacle::RcsCampaignSchemaExtraUseCase] Use case classification for the campaign.
    ...
    # @param agent [Pinnacle::RcsCampaignSchemaExtraAgent] Agent configured to the campaign.
    ...
    # @param links [Pinnacle::RcsCampaignSchemaExtraLinks] Legal documentation links.
    # @param opt_in [Pinnacle::RcsCampaignSchemaExtraOptIn] Opt-in configuration.
    # @param opt_out [Pinnacle::RcsCampaignSchemaExtraOptOut] Opt-out configuration.
    # @param use_case [Pinnacle::RcsCampaignSchemaExtraUseCase] Use case classification for the campaign.
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["agent"].nil?
        ...
        agent = Pinnacle::RcsCampaignSchemaExtraAgent.from_json(json_object: agent)
      end
      ...
      if parsed_json["links"].nil?
        ...
        links = Pinnacle::RcsCampaignSchemaExtraLinks.from_json(json_object: links)
      end
      if parsed_json["optIn"].nil?
        opt_in = nil
      else
        opt_in = parsed_json["optIn"].to_json
        opt_in = Pinnacle::RcsCampaignSchemaExtraOptIn.from_json(json_object: opt_in)
      end
      if parsed_json["optOut"].nil?
        opt_out = nil
      else
        opt_out = parsed_json["optOut"].to_json
        opt_out = Pinnacle::RcsCampaignSchemaExtraOptOut.from_json(json_object: opt_out)
      end
      if parsed_json["useCase"].nil?
        use_case = nil
      else
        use_case = parsed_json["useCase"].to_json
        use_case = Pinnacle::RcsCampaignSchemaExtraUseCase.from_json(json_object: use_case)
      end
      new(
        agent: agent,
        agent_id: agent_id,
    ...
    def self.validate_raw(obj:)
      Pinnacle::RcsCampaignSchemaExtraAgent.validate_raw(obj: obj.agent)
      ...
      Pinnacle::RcsCampaignSchemaExtraLinks.validate_raw(obj: obj.links)
      Pinnacle::RcsCampaignSchemaExtraOptIn.validate_raw(obj: obj.opt_in)
      Pinnacle::RcsCampaignSchemaExtraOptOut.validate_raw(obj: obj.opt_out)
      Pinnacle::RcsCampaignSchemaExtraUseCase.validate_raw(obj: obj.use_case)
    end
  end
end
