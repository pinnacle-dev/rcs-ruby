...
module Pinnacle
  ...
  class AttachWebhookSchemaWebhookId
    ...
    # @return [Pinnacle::WebhookEventEnum] Select the event type that will trigger this webhook. <br>
    ...
    #  Make sure this webhook is active and able to receive event notifications.
    # @param event [Pinnacle::WebhookEventEnum] Select the event type that will trigger this webhook. <br>
    #  Set to null if you want to listen to all event types for this phone number. <br>
    #  Defaults to null.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::AttachWebhookSchemaWebhookId]
