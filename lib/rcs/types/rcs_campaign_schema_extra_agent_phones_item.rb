...
module Pinnacle
  module Types
    class RcsCampaignSchemaExtraAgentPhonesItem
      ...
      # @return [Pinnacle::Types::RcsCampaignSchemaExtraAgentPhonesItem]
      ...
      # Serialize an instance of RcsCampaignSchemaExtraAgentPhonesItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
