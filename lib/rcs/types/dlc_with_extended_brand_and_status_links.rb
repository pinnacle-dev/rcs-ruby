...
module Pinnacle
  module Types
    ...
    class DlcWithExtendedBrandAndStatusLinks
      ...
      # @return [Pinnacle::Types::DlcWithExtendedBrandAndStatusLinks]
      ...
      # Deserialize a JSON object to an instance of DlcWithExtendedBrandAndStatusLinks
      #
      ...
      # Serialize an instance of DlcWithExtendedBrandAndStatusLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
