...
module Pinnacle
  module Types
    class RcsCampaignSchemaExtraAgentEmailsItem
      ...
      # @return [Pinnacle::Types::RcsCampaignSchemaExtraAgentEmailsItem]
      ...
      # Serialize an instance of RcsCampaignSchemaExtraAgentEmailsItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
