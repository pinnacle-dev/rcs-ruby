...
module Pinnacle
  ...
  class CampaignQuery
    ...
    # @param type [Pinnacle::CampaignEnum]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::CampaignQuery]
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Pinnacle::CampaignEnum) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
    end
  end
end
