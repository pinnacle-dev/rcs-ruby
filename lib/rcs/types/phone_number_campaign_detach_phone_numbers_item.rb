...
module Pinnacle
  module Types
    class PhoneNumberCampaignDetachPhoneNumbersItem
      ...
      # @return [Pinnacle::Types::PhoneNumberCampaignDetachPhoneNumbersItemCampaign] Campaign that the phone is now detached from.
      ...
      # @param campaign [Pinnacle::Types::PhoneNumberCampaignDetachPhoneNumbersItemCampaign] Campaign that the phone is now detached from.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Pinnacle::Types::PhoneNumberCampaignDetachPhoneNumbersItem]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["campaign"].nil?
          ...
          campaign = Pinnacle::Types::PhoneNumberCampaignDetachPhoneNumbersItemCampaign.from_json(json_object: campaign)
        end
        new(
          phone_number: phone_number,
          campaign: campaign,
      ...
      def self.validate_raw(obj:)
        ...
        Pinnacle::Types::PhoneNumberCampaignDetachPhoneNumbersItemCampaign.validate_raw(obj: obj.campaign)
      end
    end
  end
end
