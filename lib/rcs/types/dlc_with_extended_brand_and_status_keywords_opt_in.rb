...
module Pinnacle
  ...
  class DlcWithExtendedBrandAndStatusKeywordsOptIn
    ...
    # @return [Pinnacle::DlcWithExtendedBrandAndStatusKeywordsOptIn]
    ...
    # Serialize an instance of DlcWithExtendedBrandAndStatusKeywordsOptIn to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
