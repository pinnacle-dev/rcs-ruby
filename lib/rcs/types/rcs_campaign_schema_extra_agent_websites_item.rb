...
module Pinnacle
  module Types
    class RcsCampaignSchemaExtraAgentWebsitesItem
      ...
      # @return [Pinnacle::Types::RcsCampaignSchemaExtraAgentWebsitesItem]
      ...
      # Serialize an instance of RcsCampaignSchemaExtraAgentWebsitesItem to a JSON
      #  object
      #
      # @return [String]
      def to_json(*_args)
