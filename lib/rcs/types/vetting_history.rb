...
module Pinnacle
  class VettingHistory
    ...
    # @return [Pinnacle::VettingHistoryVettingStatus] Current status of the vetting process.
    ...
    # @param vetting_status [Pinnacle::VettingHistoryVettingStatus] Current status of the vetting process.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::VettingHistory]
    ...
    def self.validate_raw(obj:)
      ...
      obj.vetting_status.is_a?(Pinnacle::VettingHistoryVettingStatus) != false || raise("Passed value for field obj.vetting_status is not the expected type, validation failed.")
    end
  end
end
