...
module Pinnacle
  ...
  class RcsCampaignSchemaExtraAgent
    ...
    # @return [Array<Pinnacle::RcsCampaignSchemaExtraAgentEmailsItem>] List of emails.
    attr_reader :emails
    ...
    attr_reader :name
    # @return [Array<Pinnacle::RcsCampaignSchemaExtraAgentPhonesItem>] List of phone numbers.
    attr_reader :phones
    # @return [Array<Pinnacle::RcsCampaignSchemaExtraAgentWebsitesItem>] List of urls.
    ...
    # @param emails [Array<Pinnacle::RcsCampaignSchemaExtraAgentEmailsItem>] List of emails.
    ...
    # @param phones [Array<Pinnacle::RcsCampaignSchemaExtraAgentPhonesItem>] List of phone numbers.
    # @param websites [Array<Pinnacle::RcsCampaignSchemaExtraAgentWebsitesItem>] List of urls.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::RcsCampaignSchemaExtraAgent]
    ...
    def self.from_json(json_object:)
      ...
      emails = parsed_json["emails"]&.map do |item|
        item = item.to_json
        Pinnacle::RcsCampaignSchemaExtraAgentEmailsItem.from_json(json_object: item)
      end
      ...
      phones = parsed_json["phones"]&.map do |item|
        item = item.to_json
        Pinnacle::RcsCampaignSchemaExtraAgentPhonesItem.from_json(json_object: item)
      end
      websites = parsed_json["websites"]&.map do |item|
        item = item.to_json
        Pinnacle::RcsCampaignSchemaExtraAgentWebsitesItem.from_json(json_object: item)
      end
      new(
        color: color,
        description: description,
