...
module Pinnacle
  ...
  class TollFreeCampaignStatus
    ...
    attr_reader :id
    # @return [Pinnacle::GetTollFreeCampaignStatusResponseUpdates] Status of phone numbers that are being attached to this campaign. <br>
    ...
    # @param updates [Pinnacle::GetTollFreeCampaignStatusResponseUpdates] Status of phone numbers that are being attached to this campaign. <br>
    #  Note that phone numbers can only be attached to `VERIFIED` campaigns via the
    #  [attach campaign endpoint](../phone-numbers/attach-campaign).
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["updates"].nil?
        ...
        updates = Pinnacle::GetTollFreeCampaignStatusResponseUpdates.from_json(json_object: updates)
      end
      new(
        error: error,
        id: id,
    ...
    def self.validate_raw(obj:)
      ...
      Pinnacle::GetTollFreeCampaignStatusResponseUpdates.validate_raw(obj: obj.updates)
    end
  end
end
