...
module Pinnacle
  class RcsCampaign
    # @return [Pinnacle::RcsCampaignSchemaAgent] Agent configured to the campaign.
    attr_reader :agent
    ...
    # @return [Pinnacle::RcsCampaignSchemaLinks] Legal documentation links.
    attr_reader :links
    # @return [Pinnacle::RcsCampaignSchemaOptIn] Opt-in configuration.
    attr_reader :opt_in
    # @return [Pinnacle::RcsCampaignSchemaOptOut] Opt-out configuration.
    attr_reader :opt_out
    # @return [Pinnacle::RcsCampaignSchemaUseCase] Use case classification for the campaign.
    ...
    # @param agent [Pinnacle::RcsCampaignSchemaAgent] Agent configured to the campaign.
    ...
    # @param links [Pinnacle::RcsCampaignSchemaLinks] Legal documentation links.
    # @param opt_in [Pinnacle::RcsCampaignSchemaOptIn] Opt-in configuration.
    # @param opt_out [Pinnacle::RcsCampaignSchemaOptOut] Opt-out configuration.
    # @param use_case [Pinnacle::RcsCampaignSchemaUseCase] Use case classification for the campaign.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::RcsCampaign]
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["agent"].nil?
        ...
        agent = Pinnacle::RcsCampaignSchemaAgent.from_json(json_object: agent)
      end
      ...
      if parsed_json["links"].nil?
        ...
        links = Pinnacle::RcsCampaignSchemaLinks.from_json(json_object: links)
      end
      if parsed_json["optIn"].nil?
        opt_in = nil
      else
        opt_in = parsed_json["optIn"].to_json
        opt_in = Pinnacle::RcsCampaignSchemaOptIn.from_json(json_object: opt_in)
      end
      if parsed_json["optOut"].nil?
        opt_out = nil
      else
        opt_out = parsed_json["optOut"].to_json
        opt_out = Pinnacle::RcsCampaignSchemaOptOut.from_json(json_object: opt_out)
      end
      if parsed_json["useCase"].nil?
        use_case = nil
      else
        use_case = parsed_json["useCase"].to_json
        use_case = Pinnacle::RcsCampaignSchemaUseCase.from_json(json_object: use_case)
      end
      new(
        agent: agent,
    ...
    def self.validate_raw(obj:)
      obj.agent.nil? || Pinnacle::RcsCampaignSchemaAgent.validate_raw(obj: obj.agent)
      ...
      obj.links.nil? || Pinnacle::RcsCampaignSchemaLinks.validate_raw(obj: obj.links)
      obj.opt_in.nil? || Pinnacle::RcsCampaignSchemaOptIn.validate_raw(obj: obj.opt_in)
      obj.opt_out.nil? || Pinnacle::RcsCampaignSchemaOptOut.validate_raw(obj: obj.opt_out)
      obj.use_case.nil? || Pinnacle::RcsCampaignSchemaUseCase.validate_raw(obj: obj.use_case)
    end
  end
end
