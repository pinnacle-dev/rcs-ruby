...
module Pinnacle
  class VCardData
    # @return [Pinnacle::VCardDataFile] File associated to the contact.
    attr_reader :file
    ...
    # @param file [Pinnacle::VCardDataFile] File associated to the contact.
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["file"].nil?
        ...
        file = Pinnacle::VCardDataFile.from_json(json_object: file)
      end
    ...
    def self.validate_raw(obj:)
      Pinnacle::VCardDataFile.validate_raw(obj: obj.file)
