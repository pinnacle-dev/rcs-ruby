...
module Pinnacle
  class ExtendedBrandWithVetting
    ...
    # @return [Array<Pinnacle::VettingFeedback>] Feedback from The Campaign Registry if TCR vetting was performed.
    attr_reader :tcr_feedback
    # @return [Array<Pinnacle::VettingHistory>] History of all external vetting attempts for this brand.
    ...
    # @param tcr_feedback [Array<Pinnacle::VettingFeedback>] Feedback from The Campaign Registry if TCR vetting was performed.
    # @param vetting_history [Array<Pinnacle::VettingHistory>] History of all external vetting attempts for this brand.
    ...
    def initialize(vetting_history:, created_at:, id:, is_archived:, status:, updated_at:, last_tcr_vetting_date: OMIT,
                   tcr_feedback: OMIT, address: OMIT, contact: OMIT, dba: OMIT, description: OMIT, ein: OMIT, email: OMIT, name: OMIT, sector: OMIT, type: OMIT, website: OMIT, additional_properties: nil)
    ...
    def self.from_json(json_object:)
      ...
      tcr_feedback = parsed_json["tcrFeedback"]&.map do |item|
        item = item.to_json
        Pinnacle::VettingFeedback.from_json(json_object: item)
      end
      vetting_history = parsed_json["vettingHistory"]&.map do |item|
        item = item.to_json
        Pinnacle::VettingHistory.from_json(json_object: item)
      end
