...
module Pinnacle
  module Types
    ...
    class VCardDataFileMetadata
      # @return [String] When the download URL expires in ISO 8601 format.<br>
      ...
      # @param expires_at [String] When the download URL expires in ISO 8601 format.<br>
      #  Null indicates that it is permanent.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Pinnacle::Types::VCardDataFileMetadata]
      ...
      # Deserialize a JSON object to an instance of VCardDataFileMetadata
      #
      ...
      # Serialize an instance of VCardDataFileMetadata to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
