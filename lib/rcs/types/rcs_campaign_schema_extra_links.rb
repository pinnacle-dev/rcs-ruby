...
module Pinnacle
  module Types
    ...
    class RcsCampaignSchemaExtraLinks
      ...
      # @return [Pinnacle::Types::RcsCampaignSchemaExtraLinks]
      ...
      # Deserialize a JSON object to an instance of RcsCampaignSchemaExtraLinks
      #
      ...
      # Serialize an instance of RcsCampaignSchemaExtraLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
