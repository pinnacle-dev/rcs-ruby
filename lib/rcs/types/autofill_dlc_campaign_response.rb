...
module Pinnacle
  class AutofillDlcCampaignResponse
    ...
    # @return [Pinnacle::AutofillDlcResponseKeywords] Keyword response configuration.
    attr_reader :keywords
    # @return [Pinnacle::AutofillDlcResponseLinks] Legal documentation links.
    attr_reader :links
    ...
    attr_reader :name
    # @return [Pinnacle::AutofillDlcResponseOptions] Campaign configuration options.
    attr_reader :options
    # @return [Array<String>] Example messages for the campaign.
    attr_reader :sample_messages
    # @return [Pinnacle::AutofillDlcResponseUseCase] Use case for the campaign.
    ...
    # @param keywords [Pinnacle::AutofillDlcResponseKeywords] Keyword response configuration.
    # @param links [Pinnacle::AutofillDlcResponseLinks] Legal documentation links.
    ...
    # @param options [Pinnacle::AutofillDlcResponseOptions] Campaign configuration options.
    # @param sample_messages [Array<String>] Example messages for the campaign.
    # @param use_case [Pinnacle::AutofillDlcResponseUseCase] Use case for the campaign.
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["keywords"].nil?
        ...
        keywords = Pinnacle::AutofillDlcResponseKeywords.from_json(json_object: keywords)
      end
      if parsed_json["links"].nil?
        links = nil
      else
        links = parsed_json["links"].to_json
        links = Pinnacle::AutofillDlcResponseLinks.from_json(json_object: links)
      end
      ...
      if parsed_json["options"].nil?
        ...
        options = Pinnacle::AutofillDlcResponseOptions.from_json(json_object: options)
      end
      ...
      if parsed_json["useCase"].nil?
        ...
        use_case = Pinnacle::AutofillDlcResponseUseCase.from_json(json_object: use_case)
      end
      new(
        auto_renew: auto_renew,
        brand: brand,
    ...
    def self.validate_raw(obj:)
      ...
      obj.keywords.nil? || Pinnacle::AutofillDlcResponseKeywords.validate_raw(obj: obj.keywords)
      obj.links.nil? || Pinnacle::AutofillDlcResponseLinks.validate_raw(obj: obj.links)
      ...
      obj.options.nil? || Pinnacle::AutofillDlcResponseOptions.validate_raw(obj: obj.options)
      ...
      obj.use_case.nil? || Pinnacle::AutofillDlcResponseUseCase.validate_raw(obj: obj.use_case)
    end
  end
end
