...
module Pinnacle
  class UploadResults
    ...
    # @return [Pinnacle::PinnacleFileUploadMetadata]
    ...
    # @param metadata [Pinnacle::PinnacleFileUploadMetadata]
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["metadata"].nil?
        ...
        metadata = Pinnacle::PinnacleFileUploadMetadata.from_json(json_object: metadata)
      end
      new(
        upload_url: upload_url,
        download_url: download_url,
    ...
    def self.validate_raw(obj:)
      ...
      Pinnacle::PinnacleFileUploadMetadata.validate_raw(obj: obj.metadata)
    end
  end
end
