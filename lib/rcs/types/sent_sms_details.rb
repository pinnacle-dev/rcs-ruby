...
module Pinnacle
  class SentSmsDetails
    ...
    # @return [Pinnacle::SendSmsResponseSegments] Details about how the message was segmented for sending.
    ...
    # @param segments [Pinnacle::SendSmsResponseSegments] Details about how the message was segmented for sending.
    ...
    # @return [Pinnacle::SentSmsDetails]
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["segments"].nil?
        ...
        segments = Pinnacle::SendSmsResponseSegments.from_json(json_object: segments)
      end
    ...
    def self.validate_raw(obj:)
      ...
      Pinnacle::SendSmsResponseSegments.validate_raw(obj: obj.segments)
