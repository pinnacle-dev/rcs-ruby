...
module Pinnacle
  ...
  class BasicPhoneInformationLocation
    # @return [Pinnacle::BasicPhoneInformationLocationCountry] Information about the country of registration.
    attr_reader :country
    ...
    # @param country [Pinnacle::BasicPhoneInformationLocationCountry] Information about the country of registration.
    # @param place [String] Location description including region, state/province, and city.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::BasicPhoneInformationLocation]
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["country"].nil?
        ...
        country = Pinnacle::BasicPhoneInformationLocationCountry.from_json(json_object: country)
      end
    ...
    def self.validate_raw(obj:)
      Pinnacle::BasicPhoneInformationLocationCountry.validate_raw(obj: obj.country)
