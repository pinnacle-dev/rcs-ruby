...
module Pinnacle
  ...
  class AdvancedPhoneInformationContact
    ...
    attr_reader :country
    # @return [Pinnacle::ENHANCED_CONTACT] Collection of online profiles and social media accounts associated with the
    #  contact. <br>
    ...
    # @param profiles [Pinnacle::ENHANCED_CONTACT] Collection of online profiles and social media accounts associated with the
    #  contact. <br>
    #  These are potential candidates and may be inaccurate. Always double check.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::AdvancedPhoneInformationContact]
    ...
    def self.from_json(json_object:)
      ...
      profiles = parsed_json["profiles"]&.map do |item|
        item = item.to_json
        Pinnacle::EnhancedContactItem.from_json(json_object: item)
      end
      new(
