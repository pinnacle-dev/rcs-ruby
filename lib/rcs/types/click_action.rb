...
module Pinnacle
  class ClickAction
    ...
    attr_reader :button
    # @return [Pinnacle::ClickActionData] Payload received from the button interaction.
    attr_reader :data
    ...
    # @param data [Pinnacle::ClickActionData] Payload received from the button interaction.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::ClickAction]
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["data"].nil?
        ...
        data = Pinnacle::ClickActionData.from_json(json_object: data)
      end
      new(
        button: button,
        data: data,
    ...
    def self.validate_raw(obj:)
      ...
      Pinnacle::ClickActionData.validate_raw(obj: obj.data)
    end
  end
end
