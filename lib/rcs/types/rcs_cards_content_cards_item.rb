...
module Pinnacle
  ...
  class RcsCardsContentCardsItem
    # @return [Array<Pinnacle::RcsButtonContent>] Action buttons attached to the card.
    attr_reader :buttons
    ...
    # @param buttons [Array<Pinnacle::RcsButtonContent>] Action buttons attached to the card.
    ...
    # @return [Pinnacle::RcsCardsContentCardsItem]
    ...
    def self.validate_raw(obj:)
      ...
      obj.media.nil? || Pinnacle::RcsMediaDetailsContent.validate_raw(obj: obj.media)
