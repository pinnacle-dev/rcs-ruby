...
module Pinnacle
  ...
  class CarouselRcsMessage
    # @return [Array<Pinnacle::Card>] Array of cards to be sent
    attr_reader :cards
    ...
    # @param cards [Array<Pinnacle::Card>] Array of cards to be sent
    ...
    # @return [Pinnacle::CarouselRcsMessage]
    ...
    # Deserialize a JSON object to an instance of CarouselRcsMessage
    #
    ...
    # Serialize an instance of CarouselRcsMessage to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
