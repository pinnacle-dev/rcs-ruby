...
module Pinnacle
  ...
  class DlcWithExtendedBrandAndStatusKeywordsHelp
    ...
    # @return [Pinnacle::DlcWithExtendedBrandAndStatusKeywordsHelp]
    ...
    # Serialize an instance of DlcWithExtendedBrandAndStatusKeywordsHelp to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
