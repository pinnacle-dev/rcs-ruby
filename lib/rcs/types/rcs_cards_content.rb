...
module Pinnacle
  ...
  class RcsCardsContent
    # @return [Array<Pinnacle::RcsCardsContentCardsItem>] Collection of cards attached to the message.
    attr_reader :cards
    ...
    # @param cards [Array<Pinnacle::RcsCardsContentCardsItem>] Collection of cards attached to the message.
    ...
    # @return [Pinnacle::RcsCardsContent]
    ...
    def self.from_json(json_object:)
      ...
      cards = parsed_json["cards"]&.map do |item|
        item = item.to_json
        Pinnacle::RcsCardsContentCardsItem.from_json(json_object: item)
      end
