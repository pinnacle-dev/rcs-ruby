...
module Pinnacle
  ...
  class RcsButtonSendLocation
    # @return [Pinnacle::RcsButtonSendLocationLatLong] Geographic coordinates of the location to share.
    ...
    # @param lat_long [Pinnacle::RcsButtonSendLocationLatLong] Geographic coordinates of the location to share.
    # @param title [String] Display text for the button.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::RcsButtonSendLocation]
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["latLong"].nil?
        ...
        lat_long = Pinnacle::RcsButtonSendLocationLatLong.from_json(json_object: lat_long)
      end
    ...
    def self.validate_raw(obj:)
      Pinnacle::RcsButtonSendLocationLatLong.validate_raw(obj: obj.lat_long)
