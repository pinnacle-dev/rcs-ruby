...
module Pinnacle
  ...
  class GetDlcCampaignStatusResponseUpdates
    ...
    attr_reader :number
    # @return [Pinnacle::DlcAssignmentStatusEnum] Current assignment status of the phone number to this campaign. <br>
    ...
    # @param status [Pinnacle::DlcAssignmentStatusEnum] Current assignment status of the phone number to this campaign. <br>
    #  `ASSIGNED`: Number assigned and ready to send messages.<br>
    #  `PENDING_ASSIGNMENT`: In the process of being assigned. This should take no more
    #  than 10 minutes.<br>
    #  `PENDING_UNASSIGNMENT`: In the process of being unassigned. This should take no
    ...
    # @return [Pinnacle::GetDlcCampaignStatusResponseUpdates]
    ...
    def self.validate_raw(obj:)
      ...
      obj.status.is_a?(Pinnacle::DlcAssignmentStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
