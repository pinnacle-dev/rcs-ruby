...
module Pinnacle
  class SmsValidationResult
    ...
    # @return [Pinnacle::SmsValidationResponseSegments] Details about how the SMS content would be segmented for delivery.
    attr_reader :segments
    # @return [Pinnacle::SmsValidationResponseTotal]
    attr_reader :total
    ...
    #  For SMS, this is limit is 10.
    # @param segments [Pinnacle::SmsValidationResponseSegments] Details about how the SMS content would be segmented for delivery.
    # @param total [Pinnacle::SmsValidationResponseTotal]
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["segments"].nil?
        ...
        segments = Pinnacle::SmsValidationResponseSegments.from_json(json_object: segments)
      end
      if parsed_json["total"].nil?
        total = nil
      else
        total = parsed_json["total"].to_json
        total = Pinnacle::SmsValidationResponseTotal.from_json(json_object: total)
      end
    ...
    def self.validate_raw(obj:)
      ...
      Pinnacle::SmsValidationResponseSegments.validate_raw(obj: obj.segments)
      Pinnacle::SmsValidationResponseTotal.validate_raw(obj: obj.total)
