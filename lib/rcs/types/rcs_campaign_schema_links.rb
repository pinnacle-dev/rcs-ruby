...
module Pinnacle
  module Types
    ...
    class RcsCampaignSchemaLinks
      ...
      # @return [Pinnacle::Types::RcsCampaignSchemaLinks]
      ...
      # Deserialize a JSON object to an instance of RcsCampaignSchemaLinks
      #
      ...
      # Serialize an instance of RcsCampaignSchemaLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
