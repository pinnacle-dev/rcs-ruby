...
module Pinnacle
  module Types
    class RcsCampaignSchemaAgentEmailsItem
      ...
      # @return [Pinnacle::Types::RcsCampaignSchemaAgentEmailsItem]
      ...
      # Deserialize a JSON object to an instance of RcsCampaignSchemaAgentEmailsItem
      #
      ...
      # Serialize an instance of RcsCampaignSchemaAgentEmailsItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
