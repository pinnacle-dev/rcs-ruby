...
module Pinnacle
  class UpdateCompanyResponseBrand
    # @return [String]
    attr_reader :name
    # @return [Float]
    attr_reader :id
    ...
    # Deserialize a JSON object to an instance of UpdateCompanyResponseBrand
    #
    ...
    # Serialize an instance of UpdateCompanyResponseBrand to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
