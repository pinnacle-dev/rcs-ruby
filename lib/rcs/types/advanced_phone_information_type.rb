...
module Pinnacle
  ...
  class AdvancedPhoneInformationType
    # @return [Pinnacle::DetailedPhoneNumberEnum] Technical classification derived from carrier intelligence systems.
    attr_reader :value
    ...
    attr_reader :details
    # @return [Pinnacle::AdvancedPhoneInformationTypeRecommendation] Security recommendation based on fraud risk analysis:
    ...
    # @param value [Pinnacle::DetailedPhoneNumberEnum] Technical classification derived from carrier intelligence systems.
    ...
    #  and typical usage patterns for this number classification.
    # @param recommendation [Pinnacle::AdvancedPhoneInformationTypeRecommendation] Security recommendation based on fraud risk analysis:
    #  - `ALLOW`: Low risk, safe for normal use.
    #  - `BLOCK`: High risk, block or require additional verification.
    #  - `FLAG`: Medium risk, recommend further scrutiny or monitoring.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Pinnacle::AdvancedPhoneInformationType]
    def initialize(value:, description:, details:, recommendation:, additional_properties: nil)
      ...
      @_field_set = { "value": value, "description": description, "details": details, "recommendation": recommendation }
    end
    ...
    def self.validate_raw(obj:)
      obj.value.is_a?(Pinnacle::DetailedPhoneNumberEnum) != false || raise("Passed value for field obj.value is not the expected type, validation failed.")
      ...
      obj.recommendation.is_a?(Pinnacle::AdvancedPhoneInformationTypeRecommendation) != false || raise("Passed value for field obj.recommendation is not the expected type, validation failed.")
    end
  end
end
