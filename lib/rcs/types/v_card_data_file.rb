...
module Pinnacle
  module Types
    ...
    class VCardDataFile
      ...
      attr_reader :url
      # @return [Pinnacle::Types::VCardDataFileMetadata] Additional information about the download URL.
      ...
      # @param metadata [Pinnacle::Types::VCardDataFileMetadata] Additional information about the download URL.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Pinnacle::Types::VCardDataFile]
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["metadata"].nil?
          ...
          metadata = Pinnacle::Types::VCardDataFileMetadata.from_json(json_object: metadata)
        end
        new(
          url: url,
          metadata: metadata,
      ...
      def self.validate_raw(obj:)
        ...
        Pinnacle::Types::VCardDataFileMetadata.validate_raw(obj: obj.metadata)
      end
    end
  end
end
