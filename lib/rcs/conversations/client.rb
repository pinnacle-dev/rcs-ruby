...
module Rcs
  module Conversations
    class Client
      ...
      # @param params [Rcs::Types::GetConversationParams]
      ...
      #
      # @return [Rcs::Types::Conversation, nil]
      def get(request_options: {}, **params)
        ...
        request = Rcs::Internal::JSON::Request.new(
          ...
          body: Rcs::Types::GetConversationParams.new(params).to_h,
      ...
      #
      # @param request_options [Hash]
      # @param params [Rcs::Conversations::Types::ListConversationsParams]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [Rcs::Types::ConversationList]
      def list(request_options: {}, **params)
        ...
        request = Rcs::Internal::JSON::Request.new(
          ...
          body: Rcs::Conversations::Types::ListConversationsParams.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        if code.between?(200, 299)
          Rcs::Types::ConversationList.load(response.body)
        else
          error_class = Rcs::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @param request_options [Hash]
      # @param params [Rcs::Conversations::Types::UpdateConversationParams]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [Rcs::Types::SuccessfulConversationUpdate]
      def update(request_options: {}, **params)
        ...
        request = Rcs::Internal::JSON::Request.new(
          ...
          body: Rcs::Conversations::Types::UpdateConversationParams.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Rcs::Types::SuccessfulConversationUpdate.load(response.body)
        else
          error_class = Rcs::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [Rcs::Conversations::Types::ConversationsListMessagesRequestSortOrder, nil] :sort_order
      # @option params [Rcs::Conversations::Types::ConversationsListMessagesRequestDirection, nil] :direction
      # @option params [Rcs::Conversations::Types::ConversationsListMessagesRequestStatus, nil] :status
      # @option params [Rcs::Conversations::Types::ConversationsListMessagesRequestType, nil] :type
      # @option params [String, nil] :date_from
      # @option params [String, nil] :date_to
      #
      # @return [Rcs::Types::MessageList]
      def list_messages(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Rcs::Types::MessageList.load(response.body)
        else
          error_class = Rcs::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
