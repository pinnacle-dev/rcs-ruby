...
require_relative "custom.gemspec.rb"
...
Gem::Specification.new do |spec|
  spec.name = "pinnacle"
  spec.authors = ["Pinnacle"]
  spec.version = Pinnacle::VERSION
  spec.summary = "Ruby client library for the Pinnacle API"
  spec.description = "The Pinnacle Ruby library provides convenient access to the Pinnacle API from Ruby."
