...
require_relative "lib/rcs/version"
...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Ruby client library for the Rcs API"
  spec.description = "The Rcs Ruby library provides convenient access to the Rcs API from Ruby."
